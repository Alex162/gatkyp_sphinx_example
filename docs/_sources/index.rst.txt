...
For more information check out `KU Leuven webpage for MARVEL <https://fys.kuleuven.be/ster/instruments/marvel>`_ and the `SPIE paper on MARVEL <https://arxiv.org/pdf/2012.08121.pdf>`_. (Copyright to the `KU Leuven MARVEL page <https://fys.kuleuven.be/ster/instruments/marvel>`_).
